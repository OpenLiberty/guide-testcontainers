...
Wait a moment for dev mode to start. Some error messages are expected and result from docker build printing messages to the standard err stream.  After you see the following message, your Liberty instance is ready in dev mode:
