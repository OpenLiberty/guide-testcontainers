...
Wait a moment for dev mode to start. Some error messages are expected and result from building docker image to print out messages on the standard error stream. After you see the following message, your Liberty instance is ready in dev mode:
