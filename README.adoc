...
To try out the test, first go to the `finish` directory and run the following Maven goal to build the application, starts the containers, runs the tests, and then stops the containers:
