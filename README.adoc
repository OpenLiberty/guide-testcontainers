...
Next, you'll define a custom `LibertyContainer` class, which provides a framework to start and access a containerized version of the Open Liberty application for testing.
